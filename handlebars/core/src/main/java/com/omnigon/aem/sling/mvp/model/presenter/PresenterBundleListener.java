...
/**
 * This listener monitors bundles lifecycle and scans them for classes annotated with @Presenter annotation.
 * TODO: scanning bundles may be a time-consuming process, possible optimization is to provided a list of bundles
 * that should be scanned. List of bundles configuration can be easily implemented in a host (project) bundle.
 */
